          ...
          <div class="animated fadeInLeft col-md-8">
            <div class="card card-info card-outline">
              <div class="card-header">
                <a class="btn btn-info btn-sm" href="<?php echo base_url(); ?>arsip_master/ruangan_tambah"><i class="bi bi-plus-square"> </i> Tambah Data</a>
                    ...
                    foreach ($ruangan->result_array() as $data) { ?>
                      <tr>
                        ...
                        <td style="text-align:center;">
                          <a class="btn btn-warning btn-sm" href="<?php echo base_url() . 'arsip_master/ruangan_edit/' . $data['id_ruangan']; ?>"><i class="fa fa-edit"></i> </a>
                          <a href="<?php echo base_url('arsip_master/ruangan_delete/' . $data['id_ruangan']) ?>">
