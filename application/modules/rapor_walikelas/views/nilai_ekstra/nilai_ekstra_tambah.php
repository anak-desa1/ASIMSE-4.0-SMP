                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" style="width: 100%;" id="id_siswa" name="id_siswa">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" style="width: 100%;" id="id_ekstra" name="id_ekstra">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="nilai" class="form-control" id="select_box">
