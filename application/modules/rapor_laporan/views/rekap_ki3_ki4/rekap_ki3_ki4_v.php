             ...
             <div class="card-body p-0" style="display: block;">
                                 ...
                                 <div class="card-body">
                                     <ul class="list-group">
                                             ...
                                             <div class="pull-right">
                                                 <a>
                                                     <form action="" id="FormKI3">
                                                         ...
                                                         <button type="submit" class="btn"><i class="fa fa-chevron-right"></i> <b>Rekap Nilai KI-3 - KI-4</b> </button>
                                                     </form>
                                                 </a>
                                             </div>
                                         </li>
                                         <!-- <li class="list-group-item">
                                             <div class="pull-right">
                                                 <a>
                                                     <form action="" id="FormKI4">
                                                         <input type="hidden" name="tingkat" id="tingkat" value="<?= $pegawai['kd_sekolah'] ?>" class="form-control" data-live-search="true">
                                                         <button type="submit" class="btn"><i class="fa fa-chevron-right"></i> <b>Rekap Nilai KI-4</b> </button>
                                                     </form>
                                                 </a>
                                             </div>
                                         </li> -->
                             ...
                             <div class="col-md-8">
                                 <div class="card-body">
                                     <ul class="list-group">
                                         ...
                                         <li class="list-group-item">
                                             <div class="pull-right">
                                                 <h3 class="card-title">Untuk melihat Rekap Nilai KI-3 - KI-4 klik menu disamping </h3>
                                             </div>
                                         </li>
                                     </ul>
                                 </div>
                 ...
                 <div class="col-sm-12">
                     <div class="card card-danger">
                         <div class="card-header">
                             <h3 class="card-title">Rekap Nilai KI3 - KI4</h3>
                         </div>
                         <div class="card-body">
                             <div class="row">
                                 <div class="col-md-12">
