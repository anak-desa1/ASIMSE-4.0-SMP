              ...
              <div class="row">
                ...
                <div class="animated fadeInLeft col-md-8">
                  <div class="card card-info">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form class="form-horizontal" role="form" action="<?php echo base_url(); ?>pelanggaran_master/poin_save" method="post">
                      ...
                      <div class="card-body">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-12">
                            ...
                            <input type="hidden" name="id_poin_pelanggaran" value="<?php echo $id_poin_pelanggaran; ?>">
                            <textarea class="form-control" name="nama_poin_pelanggaran" required> <?php echo $nama_poin_pelanggaran; ?></textarea>
                          </div>
                        </div>
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Poin Pelanggaran</label>
                          <div class="col-sm-12">
                            <input type="text" class="form-control" name="poin" value="<?php echo $poin; ?>" required>
                          </div>
                        </div>
                      ...
                      <div class="card-footer">
                        ...
                        <a class="btn btn-danger float-right" href="<?php echo base_url(); ?>pelanggaran_master/poin_pelanggaran"><i class="fa fa-undo"> </i> Kembali</a>
                      </div>
                      <!-- /.card-footer -->
                    </form>
                  </div>
