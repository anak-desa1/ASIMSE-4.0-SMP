                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input class="form-control tglcalendar" type="date" name="tgl_awal" placeholder="Dari Tanggal" value="<?php echo $tgl_awal; ?>" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input class="form-control tglcalendar" type="date" name="tgl_akhir" placeholder="Dari Tanggal" value="<?php echo $tgl_akhir; ?>" required>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
