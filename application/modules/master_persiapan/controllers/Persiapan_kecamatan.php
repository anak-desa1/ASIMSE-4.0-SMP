...
class Persiapan_kecamatan extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $data['kota'] = $this->db->get('m_kota')->result_array();
            $data['kecamatan'] = $this->kecamatan->getKecamatan();

            $this->load->view('layout/header-top', $data);
            $this->load->view('data_persiapan/persiapan_kecamatan/list_css');
            ...
            $this->load->view('data_persiapan/persiapan_kecamatan/list_js');
