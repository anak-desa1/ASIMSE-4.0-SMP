        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="card card-info">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <!-- <p class="text-muted"><?= $data['nama_campus'] ?> | <?= $data['nama_sekolah'] ?> </p> -->
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="card card-warning">
                                                    ...
                                                    <form method="POST" action="<?= site_url('akademik_guru/nilai_pengetahuan/upload') ?>" enctype="multipart/form-data">
