...
<br>
    <h5> 
        <div style="text-align: right;">No REG . <?= $siswa['no_daftar'] ?> </div>
        <div style="text-align: right;">Periode : <?= $siswa['periode'] ?> </div>
    </h5>
        ...
        <div class="table-responsiv">
            <table style="font-size: 12px" class="table table-striped table-bordered table-sm ">
                <tbody>
                    ...
                    <tr>
                        <td rowspan="4"><img src="<?= base_url() ?>assets/img/avatar/avatar-3.png" width="120" /></td>
            ...
            <table style="font-size: 12px" class="table table-bordered table-striped table-sm ">
                <tbody>
                    <tr>
                        ...
                        <td class="f" style="width: 150px"><b><?= $siswa['kelas']  ?></b></td>
                        <td class="f" style="width: 150px"><b>Ukuran Baju</b></td>
                        <td class="f" style="width: 150px"><b><?= $siswa['baju']  ?></b></td>
                    </tr>
                    <tr>
                        <td class="f"><b>No NIK</b></td>
