                    ...
                    <tbody>
                        ...
                        foreach ($foto as $sk) :
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-sm btn-warning" title="Edit" id="edit_osis" data-toggle="modal" data-target="#editModal" data-ekstra_id="<?= $sk['ekstra_id']; ?>" data-judul="<?= $sk['judul']; ?>" data-text="<?= $sk['text']; ?>" data-status="<?= $sk['status']; ?>" data-gambar="<?= $sk['gambar']; ?>"><i class="fa fa-edit"></i> </a>
            ...
            <form method="post" action="<?= base_url() . $this->uri->segment(1, 0) . $this->uri->slash_segment(2, 'both') ?>/simpan_edit" id="form" role="form" id="form-action" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <div class="modal-body" id="modal-edit">
                        ...
                        <div class="mb-3">
                            <label>Deskripsi</label>
                            <textarea type="text" name="text" class="form-control" placeholder="Deskripsi" required="" id="text"></textarea>
