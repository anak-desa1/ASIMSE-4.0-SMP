        ...
        <div class="row">
          ...
          <div class="animated fadeInLeft col-md-8">
            <div class="card card-info">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" role="form" action="<?php echo base_url(); ?>arsip_master/jenis_dokumen_save" method="post">
                ...
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-12">
                      ...
                      <input type="text" class="form-control" name="nama_jenis_dokumen" value="<?php echo $nama_jenis_dokumen; ?>" required>
                    </div>
                  </div>
                ...
                <div class="card-footer">
                  ...
                  <a class="btn btn-danger float-right" href="<?php echo base_url(); ?>arsip_master/jenis_dokumen"><i class="bi bi-arrow-counterclockwise"> </i> Kembali</a>
                </div>
                <!-- /.card-footer -->
              </form>
            </div>
