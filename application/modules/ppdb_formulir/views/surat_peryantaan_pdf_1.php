...
<br>
    ...
    <div id=halaman>
        ...
        <p class="p1">1. Sanggup menaati dan mematuhi peraturan tata tertib pelajar <?= $sekolah['nama_sekolah'] ?>.</p>
        <p class="p1">2. Apabila terbukti pengguna narkotik dan obat-obat terlarang maka, saya bersedia dikembalikan Kepada orang tua saya.</p>
        ...
        <table style="width: 100%;">
            <tr>
                ...
                <td></td>
                <td style="width: 50%;">
                    <div style="text-align: center;">Kelarik, ………………………<?= substr($tahun['tahun'],0,-5) ?></div>
                    <br>
