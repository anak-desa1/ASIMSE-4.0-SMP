      ...
      <div class="row">
        ...
        <div class="animated fadeInLeft col-md-8">
          <div class="card card-info">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form class="form-horizontal" role="form" action="<?php echo base_url(); ?>arsip_master/urut_save" method="post">
              ...
              <div class="card-body">
                <div class="form-group row">
                  <label class="col-sm-5 col-form-label">Nomor Urut Penyimpanan</label>
                  <div class="col-sm-12">
                    <input type="hidden" name="tipe" value="<?php echo $tipe; ?>">
                    <input type="hidden" name="id_urut" value="<?php echo $id_urut; ?>">
                    <input type="text" class="form-control" name="nama_urut" value="<?php echo $nama_urut; ?>" required>
                  </div>
                </div>
              ...
              <div class="card-footer">
                ...
                <a class="btn btn-danger float-right" href="<?php echo base_url(); ?>arsip_master/urut"><i class="bi bi-arrow-counterclockwise"> </i> Kembali</a>
              </div>
              <!-- /.card-footer -->
            </form>
          </div>
