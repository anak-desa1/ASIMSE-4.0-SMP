...
class Data_kegiatan extends CI_Controller
{
    ...
    public function belajar()
    {
        ...
        $this->load->view('data_kegiatan/belajar/list_css');
        $this->load->view('layout/header-bottom');
        $this->load->view('layout/header-notif');
        $this->load->view('layout/main-navigation', $data);
        $this->load->view('data_kegiatan/belajar/belajar_v', $data);
        $this->load->view('layout/footer-top');
        $this->load->view('data_kegiatan/belajar/list_js');
    ...
    public function tambah()
    {
        ...
        $data['pegawai'] = $this->db->get_where('pegawai', ['email_pegawai' => $this->session->userdata('email_pegawai')])->row_array();
        $this->load->view('data_kegiatan/belajar/list_css');
        $this->load->view('data_kegiatan/belajar/belajar_add', $data);
        $this->load->view('data_kegiatan/belajar/list_js');
    }
    ...
    function edit($id)
    {
        ...
        $this->load->view('data_kegiatan/belajar/list_css');
        $this->load->view('data_kegiatan/belajar/belajar_edit', $data);
        $this->load->view('data_kegiatan/belajar/list_js');
    }
    ...
    public function simpan_tambah()
    {
        ...
        redirect('data_kegiatan/belajar');
    }
    ...
    public function berita()
    {
        ...
        // die;
        $this->load->view('layout/header-top',$data);
        $this->load->view('data_kegiatan/berita/list_css');
        $this->load->view('layout/header-bottom');
        $this->load->view('layout/header-notif');
        $this->load->view('layout/main-navigation', $data);
        $this->load->view('data_kegiatan/berita/berita_v', $data);
        $this->load->view('layout/footer-top');
        $this->load->view('data_kegiatan/berita/list_js');
        $this->load->view('layout/footer-bottom');
        $this->benchmark->mark('code_end');
    }
    ...
    public function tambah_berita()
    {
        ...
        $data['pegawai'] = $this->db->get_where('pegawai', ['email_pegawai' => $this->session->userdata('email_pegawai')])->row_array();
        $this->load->view('data_kegiatan/berita/list_css');
        $this->load->view('data_kegiatan/berita/berita_add', $data);
        $this->load->view('data_kegiatan/berita/list_js');
    }
    ...
    function edit_berita($id)
    {
        ...
        $this->load->view('data_kegiatan/berita/list_css');
        $this->load->view('data_kegiatan/berita/berita_edit', $data);
        $this->load->view('data_kegiatan/berita/list_js');
    }
    ...
    function detail_berita($id)
    {
        ...
        $data['berita'] = $this->db->get_where('profil_artikel', ['id_artikel' => $id])->row_array();
        $this->load->view('data_kegiatan/berita/list_css');
        $this->load->view('data_kegiatan/berita/berita_detail', $data);
        $this->load->view('data_kegiatan/berita/list_js');
    }
    ...
    public function galery()
    {
        ...
        // die;
        $this->load->view('layout/header-top',$data);
        $this->load->view('data_kegiatan/galery/list_css');
        $this->load->view('layout/header-bottom');
        $this->load->view('layout/header-notif');
        $this->load->view('layout/main-navigation', $data);
        $this->load->view('data_kegiatan/galery/galery_v', $data);
        $this->load->view('layout/footer-top');
        $this->load->view('data_kegiatan/galery/list_js');
        $this->load->view('layout/footer-bottom');
        $this->benchmark->mark('code_end');
    }
    ...
    public function tambah_galery()
    {
        ...
        $data['pegawai'] = $this->db->get_where('pegawai', ['email_pegawai' => $this->session->userdata('email_pegawai')])->row_array();
        $this->load->view('data_kegiatan/galery/list_css');
        $this->load->view('data_kegiatan/galery/galery_add', $data);
        $this->load->view('data_kegiatan/galery/list_js');
    }
    ...
    function edit_galery($id)
    {
        ...
        $this->load->view('data_kegiatan/galery/list_css');
        $this->load->view('data_kegiatan/galery/galery_edit', $data);
        $this->load->view('data_kegiatan/galery/list_js');
    }
    ...
    function detail_galery($id)
    {
        ...
        $this->load->view('data_kegiatan/galery/list_css');
        $this->load->view('data_kegiatan/galery/galery_detail', $data);
        $this->load->view('data_kegiatan/galery/list_js');
    }
    ...
    public function galery_plus($id)
    {
        ...
        $this->load->view('layout/header-notif');
        $this->load->view('layout/main-navigation', $data);
        $this->load->view('data_kegiatan/galery/galery_v_plus', $data);
        $this->load->view('layout/footer-top');
        $this->load->view('data_kegiatan/galery/list_js');
        $this->load->view('layout/footer-bottom');
        $this->benchmark->mark('code_end');
    ...
    public function tambah_galery_plus($id)
    {
        ...
        $data['galery'] = $this->db->get_where('profil_galeri', ['id_galeri' => $id])->row_array();
        $this->load->view('data_kegiatan/galery/list_css');
        $this->load->view('data_kegiatan/galery/galery_add_plus', $data);
        $this->load->view('data_kegiatan/galery/list_js');
    }
    ...
    function edit_galery_plus($id)
    {
        ...
        $this->load->view('data_kegiatan/galery/list_css');
        $this->load->view('data_kegiatan/galery/galery_edit_plus', $data);
        $this->load->view('data_kegiatan/galery/list_js');
    }
    ...
    public function simpan_galeryplus()
    {
        ...
        redirect('data_kegiatan/galery_plus/' . $id_galeri);
    }
