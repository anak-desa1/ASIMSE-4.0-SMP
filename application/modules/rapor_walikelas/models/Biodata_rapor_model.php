...

{
    ...
    public function get_header($id, $target)
    {
        ...
        $bagidata =
            $this->db->select('k.*,sh.nama_sekolah,sh.alamat,s.nis,s.nisn,s.nama,w.semester')
            ->from('t_kelas_siswa k')
            ->join('m_sekolah sh', 'k.kd_sekolah = sh.kd_sekolah', 'left')
            ->join('m_siswa s', 'k.id_siswa = s.nis', 'left')
    ...
    public function get_sekolah($id, $target)
    {
        ...
        $bagidata =
            $this->db->select('k.*,k.alamat alamat_s,s.*,s.alamat alamat_si,d.desa,kc.kecamatan,ko.kota,p.provinsi')
            ->from('t_kelas_siswa a')
            ->join('m_sekolah k', 'a.kd_sekolah = k.kd_sekolah', 'left')
