             ...
             <div class="card-body p-0" style="display: block;">
                                     ...
                                     <ul class="list-group">
                                         <li class="list-group-item">
                                             <div class="pull-right">
                                                 <a>
                                                     <form action="" id="FormLeger">
                                                         <input type="hidden" name="tingkat" id="tingkat" value="<?= $kelas['tingkat'] ?>" class="form-control" data-live-search="true">
                                                         <button type="submit" class="btn"><i class="fa fa-chevron-right"></i> <b>Cetak Leger</b> </button>
                                                     </form>
                                                 </a>
                                             </div>
                                         </li>
                             ...
                             <div class="col-md-8">
                                 <div class="card-body">
                                     <ul class="list-group">
                                         ...
                                         <li class="list-group-item">
                                             <div class="pull-right">
                                                 <h3 class="card-title">Untuk melihat Cetak Leger klik menu disamping </h3>
                                             </div>
                                         </li>
                                     </ul>
                                 </div>
                 ...
                 <div class="col-sm-12">
                     <div class="card card-danger">
                         <div class="card-header">
                             <h3 class="card-title">Cetak Leger</h3>
                         </div>
                         <div class="card-body">
                             <div class="row">
                                 <div class="col-md-12">
