          ...
          <div class="animated fadeInLeft col-md-8">
            <div class="card card-info card-outline">
              <div class="card-header">
                <a class="btn btn-info btn-sm" href="<?php echo base_url(); ?>arsip_master/map_tambah"><i class="bi bi-plus-square"> </i> Tambah Data</a>
                    ...
                    foreach ($map->result_array() as $data) { ?>
                      <tr>
                        ...
                        <td style="text-align:center;">
                          <a class="btn btn-warning btn-sm" href="<?php echo base_url() . 'arsip_master/map_edit/' . $data['id_map']; ?>"><i class="fa fa-edit"></i></a>
                          <a href="<?php echo base_url('arsip_master/map_delete/' . $data['id_map']) ?>">
