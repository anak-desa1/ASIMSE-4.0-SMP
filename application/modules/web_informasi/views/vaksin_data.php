<div class="card-header">
    <span style="float: right">
        <a target="_blank" href="<?= base_url() ?>informasi/mpdf_cetak/<?= $vaksin['nik'] ?>" type="button" class="btn btn-success btn-right"><i class="fas fa-print"></i> Download Sertifikat</a>
    </span>
    <h2>DATA VAKSIN </h2>
</div>
<div class="card-body">
