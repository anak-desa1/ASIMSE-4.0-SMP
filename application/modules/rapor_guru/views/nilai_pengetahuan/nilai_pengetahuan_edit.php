                         ...
                         <div class="card-body">
                             ...
                             <ul class="list-group">
                                 <?php
                                    ...
                                    ?>
                                         <li class="list-group-item"><a href="#"><i class="fa fa-chevron-right"></i> <?= $c['penilaian']; ?> - <?= $c['no_kd']; ?> - <?= $c['jenis'] ?></a></li>
                                 <?php
                                            }
                                    } else {
                                 ...
                                 <div class="active tab-pane" id="activity">
                                     ...
                                     <div class="row">
                                         <div class="table-responsive">
                                             <form method="post" action="<?= base_url() . $this->uri->segment(1, 0) . $this->uri->slash_segment(2, 'both') . 'update_simpan' ?>" role="form" id="form-action" enctype="multipart/form-data">
                                                                         ...
                                                                         <td class="text-center">
                                                                             ...
                                                                             <div class="input-group input-group-sm mb-0">
                                                                                 <div class="text-center">
                                                                                     ...
                                                                                     <input type="hidden" name="kd_id" value="<?= $c['kd_id'] ?>">
