                  ...
                  <div class="carousel-inner">
                    ...
                    foreach ($sliders as $key => $value) {
                      ...
                      echo '<div class="carousel-item ' . $active . '">
                                            <img src="' . base_url() . '/panel/dist/upload/profil_slide/' . $value->gambar . '" class="img-fluid rounded-start" style="height: 350px; width: 700px;" alt="…">
                                            <div class="carousel-caption d-none d-md-block">
                                              <h5><font color="#100F0F">' . $value->judul . '</font></h5>
                                              <p><font color="#100F0F">' . $value->text . '</font></p>
                                            </div>                                           
                                        </div>';
                    }
                    ?>
                  ...
                  <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                      ...
                      foreach ($galery as $key => $value) {
                        $active = ($key == 0) ? 'active' : '';
                        echo '<div class="carousel-item ' . $active . '">
                                            <img src="' . base_url() . '/panel/dist/upload/profil_galery/' . $value['gambar'] . '" style="height: 250px; width:auto;" alt="…">
