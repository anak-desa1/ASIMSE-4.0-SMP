                        ...
                        foreach ($periode as $periode) :
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-sm btn-warning" title="Edit" id="edit_periode" data-toggle="modal" data-target="#editModal" data-id="<?= $periode['id']; ?>" data-periode="<?= $periode['periode']; ?>" data-tgl_mulai="<?= $periode['tgl_mulai']; ?>" data-tgl_selesai="<?= $periode['tgl_selesai']; ?>" data-tahun="<?= $periode['tahun']; ?>" data-status="<?= $periode['status']; ?>"><i class="fa fa-edit"></i></a>
                                    <a href="<?= base_url() ?>ppdb_setting/deldata_periode/<?= $periode['id'] ?>" class="btn btn-sm btn-danger btn-hapus"><i class="fa fa-trash-alt"></i></a>
                                </td>
                            </tr>
                        <?php endforeach ?>
                    </tbody>
