...
class Dashboard extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['transakasi'] = $this->dashboard->transakasi();
        $data['jml_sekolah'] = $this->dashboard->jml_sekolah();
        $data['online'] = $this->dashboard->online();

        $data['statistik'] = $this->dashboard->statistik_sekolah();
        $data['jml'] = $this->dashboard->peminat_jml();
