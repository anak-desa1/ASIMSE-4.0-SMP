...
class Input_kd extends CI_Controller
{
    ...
    public function tambah($id)
    {
        ...
        // $data['p_semester'] = array('' => 'pilih semester', '1' => 'Satu', '2' => 'Dua');
    ...
    public function data_kd_ki3($id, $target)
    {
        $data['kd'] =
            $this->db->select('a.*')
            ->from('m_kd a')
            ->where(['a.id_mapel' => $id])
            ->where(['a.kelas' => $target])
            ->where(['a.jenis' => 'P'])
            ->get()->result_array();

        $this->load->view('akademik_guru/input_kd/input_kd_data_ki3', $data);
    }

    public function data_kd_ki4($id, $target)
    {
        $data['kd'] =
            $this->db->select('a.*')
            ->from('m_kd a')
        ...
        $this->load->view('akademik_guru/input_kd/input_kd_data_ki4', $data);
    }
    ...
    public function edit($id)
    {
        ...
        $this->load->view('akademik_guru/input_kd/input_kd_css');
        $this->load->view('akademik_guru/input_kd/input_kd_edit', $data);
        $this->load->view('akademik_guru/input_kd/input_kd_js');
        $this->benchmark->mark('code_end');
    }
