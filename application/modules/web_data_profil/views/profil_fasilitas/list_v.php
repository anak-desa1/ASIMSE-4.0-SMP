                                     ...
                                     <?php
                                        ...
                                        foreach ($foto as $sk) :
                                         ...
                                         <tr>
                                             ...
                                             <td>
                                                 <?php if ($sk['gambar'] != '') { ?>
                                                     <img src="<?= base_url(); ?>panel/dist/upload/profil_fasilitas/<?= $sk['gambar'] ?>" alt="..." style="width:100%;max-width:100px">
                                                 <?php } else { ?>
                                                     <img src="<?= base_url(); ?>panel/dist/upload/profil_fasilitas/200x200.png" alt="..." style="width:100%;max-width:100px">
                                                 <?php } ?>
                                             </td>
                                             <td>
                                                 <?php if ($sk['status'] == 1) { ?>
                                             ...
                                             <td>
                                                 <a class="btn btn-sm btn-warning" title="Edit" id="edit_slide" data-toggle="modal" data-target="#editModal" data-id="<?= $sk['id']; ?>" data-judul="<?= $sk['judul']; ?>" data-text="<?= $sk['text']; ?>" data-status="<?= $sk['status']; ?>" data-gambar="<?= $sk['gambar']; ?>"><i class="fa fa-edit"></i> </a>
                                                 <a href="<?= base_url() . $this->uri->segment(1, 0) . $this->uri->slash_segment(2, 'both') ?>/deldata/<?= $sk['id'] ?>" class="btn btn-sm btn-danger btn-hapus"><i class="fa fa-trash-alt"></i> </a>
                                             </td>
                                         </tr>
 ...
 <script type="text/javascript">
     $(document).on("click", "#edit_slide", function() {
         ...
         $("#modal-edit #pict").attr("src", "<?= base_url(); ?>panel/dist/upload/profil_fasilitas/" + gambar);
     })
 </script>