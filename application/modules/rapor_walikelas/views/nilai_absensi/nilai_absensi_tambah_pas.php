                 ...
                 <div class="col-md-12">
                     <div class="card">
                         ...
                         <div class="card-header p-2">
                             <a class="btn btn-warning mb-3" href="<?= base_url('akademik_walikelas/nilai_absensi'); ?>"><i class="fa fa-arrow-alt-circle-left"></i> Kembali</a>
                                         ...
                                         <div class="table-responsive">
                                             <div class="content">
                                                 ...
                                                 <table class="table table-bordered">
                                                     ...
                                                     <tbody>
                                                         <form action="<?= base_url('akademik_walikelas/nilai_absensi/absen_simpan_pas'); ?>" method="post">
                                                             <?php
                                                                $no = 1;
