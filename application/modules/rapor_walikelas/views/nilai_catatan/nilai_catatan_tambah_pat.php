                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-header p-2">
                            <a class="btn btn-warning mb-3" href="<?= base_url('akademik_walikelas/nilai_catatan'); ?>"> <i class="fa fa-arrow-circle-left"></i> Kembali</a>
                                                            ...
                                                            <table class="table table-bordered">
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th width="15%">Naik Kelas</th>
                                                                        <th width="40%">Catatan</th>
                                                                    </tr>
                                                                </thead>

                                                                <tbody>
                                                                    <form action="<?= base_url('akademik_walikelas/nilai_catatan/simpan_pat'); ?>" method="post">
                                                                        <?php
                                                                        $no = 1;
                                                                        ...
                                                                        ?>
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <?php
                                                                                        echo form_dropdown("kelas_" . $no, $p_kelas, $sk['kelas'], 'class="form-control input-sm" required id="kelas_' . $no . '"');
                                                                                        ?>
                                                                                    </td>
                                                                                    <td>
                                                                                        <?php if ($sk['tasm'] == $tasm && $sk['penilaian'] == 'PAT') { ?>
