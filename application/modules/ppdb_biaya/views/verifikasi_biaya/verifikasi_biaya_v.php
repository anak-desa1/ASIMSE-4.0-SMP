...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="table-responsive">
            <table class="table datatable table-striped table-sm" id="myTable-1" style="font-size: 16px">
                <thead>
                    <tr>
...
<div class="card">
    <div class="card-body">
        ...
        <div class="table-responsive">
            <table class="table datatable table-striped table-sm" id="myTable-2" style="font-size: 16px">
                <thead>
                    <tr>
                        <th class="text-center">
                            #
