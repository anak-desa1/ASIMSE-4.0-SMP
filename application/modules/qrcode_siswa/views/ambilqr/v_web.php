                            ...
                            <div class="box box-primary">
                                ...
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" onChang="ready()" id="id" name="nis" class="form-control" placeholder="Masukkan Nama yang terdaftar di Data Siswa">
                                    </div>
                                </div>
        ...
        <div class="content">
            <div class="panel">
                <div class="panel-body">
                    <a class="btn btn-success mb-3" href="<?= site_url('siswa_qrcode/genbar/create') ?>"><i class="fa fa-upload"></i> Import Excel</a>
...
<script type="text/javascript">
    ...
    function ready() {
        ...
        $.ajax({
            type: 'POST',
            url: '<?= base_url('/siswa_qrcode/genbar/showw') ?>',
            data: `id=${id}`,
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#id').autocomplete({
            source: "<?= site_url('siswa_qrcode/genbar/get_autocomplete'); ?>",
