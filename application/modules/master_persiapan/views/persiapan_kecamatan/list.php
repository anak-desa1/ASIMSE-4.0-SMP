                            ...
                            <tbody>
                                ...
                                <?php foreach ($kecamatan as $r) : ?>
                                    <tr>
                                        ...
                                        <td><?= $r['kecamatan']; ?></td>
                                        <td>
                                            <a class="btn btn-sm btn-warning" href="" data-kota_id="<?= $r['kota_id']; ?>" data-kecamatan="<?= $r['kecamatan']; ?>" data-id="<?= $r['kecamatan_id']; ?>" data-toggle="modal" data-target="#editModal" title="Edit"><i class="fa fa-edit"></i></a>
                                            <a href="<?= base_url('data_persiapan/persiapan_kecamatan/delkecamatan/') . $r['kecamatan_id'] ?>" class="btn btn-sm btn-danger btn-hapus"><i class="fa fa-trash-alt"></i></a>
                                        </td>
                                    </tr>
                                    <?php $i++; ?>
                                <?php endforeach; ?>
        ...
        <div class="modal-content">
            ...
            <form action="<?= base_url('data_persiapan/persiapan_kecamatan/editkecamatan'); ?>" method="post">
                <div class=" modal-body">
                    ...
                    <div class="form-group">                        
                        <select class="form-control m-bot15" style="width: 100%" id="ed_kota_id" name="ed_kota_id">
                            <option value="">Select Menu</option>
                            <?php foreach ($kota as $m) : ?>
                                <option value="<?= $m['kota_id']; ?>"><?= $m['kota']; ?></option>
                            <?php endforeach ?>
