    ...
    <section class="content">
        <div class="col-12">
            ...
            <div class="card-toolbar">
                <a href="" class="btn btn-primary mb-3 font-weight-bolder font-size-sm mr-3" data-toggle="modal" data-target="#newRoleModal">
                            ...
                            <tbody>
                                ...
                                <?php foreach ($role as $r) : ?>
                                    <tr>
                                        ...
                                        <td><?= $r['role']; ?></td>
                                        <td>
                                            <a href="<?= base_url('data_role/roleaccess/') . $r['id']; ?>" class="btn btn-sm btn-success">access</a>
                                            <a class="btn btn-sm btn-warning" href="" data-role="<?= $r['role']; ?>" data-id="<?= $r['id']; ?>" data-toggle="modal" data-target="#editModal" title="Edit"><i class="fa fa-edit"></i></a>
                                            <a href="<?= base_url('data_role/delrole/') . $r['id'] ?>" class="btn btn-sm btn-danger btn-hapus"><i class="fa fa-trash-alt"></i></a>
                                        </td>
                                    </tr>
                                    <?php $i++; ?>
                                <?php endforeach; ?>
