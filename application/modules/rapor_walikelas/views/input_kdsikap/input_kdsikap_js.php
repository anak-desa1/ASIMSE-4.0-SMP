...
<script>
    ...
    $(document).ready(function() {
        ...
        $("#sekolah").change(function() {
            var url = "<?= base_url() . $this->uri->segment(1, 0) . $this->uri->slash_segment(2, 'both') . 'add_ajax_guru' ?>/" + $(this).val();
            $('#guru').load(url);
            return false;
        })
    });
    $(document).ready(function() {
        show_loading();
        $("#sekolah").change(function() {
            var url = "<?= base_url() . $this->uri->segment(1, 0) . $this->uri->slash_segment(2, 'both') . 'add_ajax_mapel' ?>/" + $(this).val();
            $('#mapel').load(url);
            return false;
        })
    });
