          ...
          <div class="animated fadeInLeft col-md-8">
            <div class="card card-info card-outline">
              <div class="card-header">
                <!-- <a class="btn btn-info btn-sm" href="<?php echo base_url(); ?>arsip_master/jenis_dokumen_tambah"><i class="bi bi-plus-square"> </i> Tambah Data</a> -->              </div>
              <!-- /.card-header -->
                    ...
                    foreach ($jenis_dokumen->result_array() as $data) { ?>
                      <tr>
                        ...
                        <!-- <td style="text-align:center;">
                          <a class="btn btn-warning btn-sm" href="<?php echo base_url() . 'arsip_master/jenis_dokumen_edit/' . $data['id_jenis_dokumen']; ?>"><i class="fa fa-edit"></i></a>
