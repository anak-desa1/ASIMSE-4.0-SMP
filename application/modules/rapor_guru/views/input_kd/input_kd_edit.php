             ...
             <div class="modal-content">
                 ...
                 <div class="col-md-12">
                     <div class="card">
                         ...
                         <div class="card-body">
                             <form method="post" action="<?= base_url() ?>akademik_guru/input_kd/kd_ubah" enctype="multipart/form-data">
                                 ...
                                 <div class="row">
                                     <!-- <div class="col-md-2">
                                         <div class="form-group">
                                             <label>Tema<span class="symbol required"> </span></label>
                                             <input type="text" name="tema" value="<?= $kd['tema'] ?>" class="form-control">
                                         </div>
                                     </div> -->
                                     <div class="col-md-2">
                                         <div class="form-group">
                                             <label>KD<span class="symbol required"> </span></label>
                                             <input type="text" name="no_kd" value="<?= $kd['no_kd'] ?>" class="form-control" readonly>
                                         </div>
                                     </div>
                                     <div class="col-md-2">
                                         <div class="form-group">
                                     ...
                                     <div class="col-md-10">
                                         <div class="form-group">
                                             ...
                                             <!-- <textarea name="nama_kd" class="form-control" id="nama_kd" style="height: 200px" required><?= $kd['nama_kd'] ?></textarea> -->
                                             <textarea name="nama_kd" class="form-control" id="textarea" rows="8" cols="30" maxlength="115"><?= $kd['nama_kd'] ?></textarea>
