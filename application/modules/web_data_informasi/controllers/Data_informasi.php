...
class Data_informasi extends CI_Controller
{
    ...
    public function vaksin()
    {
        ...
        $this->load->view('data_informasi/vaksin/list_css');
        $this->load->view('layout/header-bottom');
        $this->load->view('layout/header-notif');
        $this->load->view('layout/main-navigation', $data);
        $this->load->view('data_informasi/vaksin/vaksin_v', $data);
        $this->load->view('layout/footer-top');
        $this->load->view('data_informasi/vaksin/list_js');
    ...
    public function tambah()
    {
        ...
        $data['pegawai'] = $this->db->get_where('pegawai', ['email_pegawai' => $this->session->userdata('email_pegawai')])->row_array();
        $this->load->view('data_informasi/vaksin/list_css');
        $this->load->view('data_informasi/vaksin/vaksin_add', $data);
        $this->load->view('data_informasi/vaksin/list_js');
    }
    ...
    function edit($id)
    {
        ...
        $this->load->view('data_informasi/vaksin/list_css');
        $this->load->view('data_informasi/vaksin/vaksin_edit', $data);
        $this->load->view('data_informasi/vaksin/list_js');
    }
    ...
    public function simpan_tambah()
    {
        ...
        redirect('data_informasi/vaksin');
    }
    ...
    public function kelulusan()
    {
        ...
        // die;
        $this->load->view('layout/header-top',$data);
        $this->load->view('data_informasi/kelulusan/list_css');
        $this->load->view('layout/header-bottom');
        $this->load->view('layout/header-notif');
        $this->load->view('layout/main-navigation', $data);
        $this->load->view('data_informasi/kelulusan/kelulusan_v', $data);
        $this->load->view('layout/footer-top');
        $this->load->view('data_informasi/kelulusan/list_js');
        $this->load->view('layout/footer-bottom');
        $this->benchmark->mark('code_end');
    }
    ...
    public function tambah_lulus()
    {
        ...
        $data['pegawai'] = $this->db->get_where('pegawai', ['email_pegawai' => $this->session->userdata('email_pegawai')])->row_array();
        $this->load->view('data_informasi/kelulusan/list_css');
        $this->load->view('data_informasi/kelulusan/kelulusan_add', $data);
        $this->load->view('data_informasi/kelulusan/list_js');
    }
    ...
    function edit_lulus($id)
    {
        ...
        $this->load->view('data_informasi/kelulusan/list_css');
        $this->load->view('data_informasi/kelulusan/kelulusan_edit', $data);
        $this->load->view('data_informasi/kelulusan/list_js');
    }
    ...
    public function simpan_lulus()
    {
        ...
        $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert"> Berhasil tambah data !!!</div>');
        redirect('data_informasi/kelulusan');
    }
    ...
    public function beasiswa()
    {
        ...
        // die;
        $this->load->view('layout/header-top',$data);
        $this->load->view('data_informasi/beasiswa/list_css');
        $this->load->view('layout/header-bottom');
        $this->load->view('layout/header-notif');
        $this->load->view('layout/main-navigation', $data);
        $this->load->view('data_informasi/beasiswa/beasiswa_v', $data);
        $this->load->view('layout/footer-top');
        $this->load->view('data_informasi/beasiswa/list_js');
        $this->load->view('layout/footer-bottom');
        $this->benchmark->mark('code_end');
    }
    ...
    public function tambah_beasiswa()
    {
        ...
        $data['pegawai'] = $this->db->get_where('pegawai', ['email_pegawai' => $this->session->userdata('email_pegawai')])->row_array();
        $this->load->view('data_informasi/beasiswa/list_css');
        $this->load->view('data_informasi/beasiswa/beasiswa_add', $data);
        $this->load->view('data_informasi/beasiswa/list_js');
    }
    ...
    function edit_beasiswa($id)
    {
        ...
        $this->load->view('data_informasi/beasiswa/list_css');
        $this->load->view('data_informasi/beasiswa/beasiswa_edit', $data);
        $this->load->view('data_informasi/beasiswa/list_js');
    }
    ...
    public function simpan_beasiswa()
    {
        ...
        $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert"> Berhasil tambah data !!!</div>');
        redirect('data_informasi/beasiswa');
    }
