                                ...
                                <ul class="list-group">
                                    ...
                                    ?>
                                            <li class="list-group-item"><?= $no ?>
                                                <a href="<?= base_url('akademik_walikelas/nilai_prestasi/input_prestasi/'); ?><?= $lk['id_siswa'] ?>">
                ...
                <div class="col-md-7">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a class="btn btn-success mb-3" href="<?= base_url('akademik_walikelas/nilai_prestasi/cetak/'); ?>" target="_blank"><i class="fa fa-print"></i> Cetak</a>
