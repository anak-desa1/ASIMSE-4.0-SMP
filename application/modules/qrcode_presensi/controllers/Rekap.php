        ...
        if ($realDiff < 32) {
            ...
            $html .= '
                <table class="table">
                    <tr>
                        ...
                        <td colspan="25" class="ctr">Tanggal Kehadiran</td>
                        <td colspan="3" class="ctr">Absensi</td>
                        <td colspan="3" width="2%" class="ctr">Ket</td>
                    </tr>
            ...
            if (!empty($siswa)) {
                ...
                foreach ($siswa as $siswa) {
                    ...
                    $html .= '<td>' . $s . '</td><td>' . $ij . '</td><td>' . $al . '</td><td></td></tr>';
                }
            }
