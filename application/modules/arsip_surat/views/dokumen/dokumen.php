                    ...
                    ?>
                      <tr>
                        ...
                        <td style="text-align:center;">
                          ...
                          <?php if ($data['id_jenis_dokumen'] == 1) { ?>
                            <a class="btn btn-info btn-xs" href="<?php echo base_url() . '/panel/dist/upload/surat_keluar/' . $data['file_dokumen']; ?>" target="_blank"><i class="fa fa-download"></i> </a>
                          <?php } ?>
                          <?php if ($data['id_jenis_dokumen'] == 2) { ?>
                            <a class="btn btn-info btn-xs" href="<?php echo base_url() . '/panel/dist/upload/surat_masuk/' . $data['file_dokumen']; ?>" target="_blank"><i class="fa fa-download"></i> </a>
                          <?php } ?>
                          <?php if ($data['id_jenis_dokumen'] == 3) { ?>
                            <a class="btn btn-info btn-xs" href="<?php echo base_url() . '/panel/dist/upload/surat_ijazah/' . $data['file_dokumen']; ?>" target="_blank"><i class="fa fa-download"></i> </a>
                          <?php } ?>
                          <a class="btn btn-warning btn-xs" href="<?php echo base_url() . 'arsip_surat/dokumen/dokumen_edit/' . $data['id_dokumen']; ?>"><i class="fa fa-edit"></i> </a>
                        </td>
                      </tr>
                    <?php $no++;
                    } ?>
