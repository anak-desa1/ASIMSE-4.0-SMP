                    ...
                    <tbody>
                        ...
                        foreach ($foto as $sk) :
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-sm btn-warning" title="Edit" id="edit_prestasi" data-toggle="modal" data-target="#editModal" data-prestasi_id="<?= $sk['prestasi_id']; ?>" data-judul="<?= $sk['judul']; ?>" data-text="<?= $sk['text']; ?>" data-status="<?= $sk['status']; ?>" data-gambar="<?= $sk['gambar']; ?>"><i class="fa fa-edit"></i> </a>
