...
class Input_ujian extends CI_Controller
{
    function __construct()
    {
        ...
        $this->load->model('Input_ujian_model', 'input_ujian');
    }
    ...
    public function index()
    {
        if ($this->form_validation->run() == false) {
            ...
            $data['tampil'] = $this->input_ujian->get_tampil();
            // var_dump($data['tampil']);
            // die;
            $this->load->view('layout/header-top');
            $this->load->view('akademik_guru/input_ujian/input_ujian_css');
            $this->load->view('layout/header-bottom');
            $this->load->view('layout/header-notif');
            $this->load->view('layout/main-navigation', $data);
            $this->load->view('akademik_guru/input_ujian/input_ujian_v', $data);
            $this->load->view('layout/footer-top');
            $this->load->view('akademik_guru/input_ujian/input_ujian_js');
