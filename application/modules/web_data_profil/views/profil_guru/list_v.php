                                ...
                                <tbody>
                                    ...
                                    foreach ($foto as $sk) :
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-sm btn-warning" title="Edit" id="edit_guru" data-toggle="modal" data-target="#editModal" data-profil_id="<?= $sk['profil_id']; ?>" data-nama_guru="<?= $sk['nama_guru']; ?>" data-mengajar="<?= $sk['mengajar']; ?>" data-status="<?= $sk['status']; ?>" data-gambar="<?= $sk['gambar']; ?>"><i class="fa fa-edit"></i></a>
