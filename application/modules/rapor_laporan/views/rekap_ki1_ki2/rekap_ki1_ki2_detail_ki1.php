                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-header p-2">
                            ...
                            <a class="btn btn-success mb-3" href="<?= base_url('akademik_laporan/rekap_ki1_ki2/ki1_cetak_pts/'); ?><?= $kelas['rombel'] ?>" target="_blank"><i class="fa fa-print"></i> Cetak PTS</a>
                            <a class="btn btn-success mb-3" href="<?= base_url('akademik_laporan/rekap_ki1_ki2/ki1_cetak_pas/'); ?><?= $kelas['rombel'] ?>" target="_blank"><i class="fa fa-print"></i> Cetak PAS</a>
                        </div><!-- /.card-header -->
                        <div class="card-body">
                                    ...
                                    <div class="content">
                                        <div class="panel-body">
                                            <div class="table-responsive">
                                                <p align="center"><b>REKAP NILAI SIKAP SEPIRITUAL</b>
