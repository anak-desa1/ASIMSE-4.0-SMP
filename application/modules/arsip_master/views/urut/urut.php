    ...
    <div class="animated fadeInLeft col-md-8">
      <div class="card card-info card-outline">
        <div class="card-header">
          <a class="btn btn-info btn-sm" href="<?php echo base_url(); ?>arsip_master/urut_tambah"><i class="bi bi-plus-square"> </i> Tambah Data</a>
        ...
        <div class="card-body table-responsive p-2">
          <table id="datatb" class="table table-bordered table-hover table-striped">
            ...
            <tbody>
              <?php
              $no = 1;
              foreach ($urut->result_array() as $data) { ?>
                <tr>
                  <td><?php echo $no; ?></td>
                  <td><?php echo $data['nama_urut']; ?></td>
                  <td style="text-align:center;">
                    <a class="btn btn-warning btn-sm" href="<?php echo base_url() . 'arsip_master/urut_edit/' . $data['id_urut']; ?>"><i class="fa fa-edit"></i> </a>
                    <a href="<?php echo base_url('arsip_master/urut_delete/' . $data['id_urut']) ?>">
