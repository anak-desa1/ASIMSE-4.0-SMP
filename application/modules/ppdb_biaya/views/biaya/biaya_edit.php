                        ...
                        <div class="card-body">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <label>Periode</label>
                                    <input type="text" name="periode" value="<?= $biaya['periode'] ?>" class="form-control" readonly>
                                </div>
                                <div class="form-group">
                                    <label>Jenis Daftar</label>
                                    <input type="text" name="jenis_daftar" value="<?= $biaya['jenis_daftar'] ?>" class="form-control" readonly>
                                </div>
                                <div class="form-group">
