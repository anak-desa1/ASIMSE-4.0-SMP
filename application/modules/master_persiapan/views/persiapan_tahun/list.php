                            ...
                            <tbody>
                                ...
                                <?php foreach ($tahun->result() as $r) : ?>
                                    <tr>
                                        ...
                                        <td><?= $r->tahun_aktif; ?></td>
                                        <td>
                                            <a class="btn btn-sm btn-warning" href=""  data-tahun_aktif="<?= $r->tahun_aktif; ?>" data-id="<?= $r->id_tahun; ?>" data-toggle="modal" data-target="#editModal" title="Edit"><i class="fa fa-edit"></i></a>
                                            <a href="<?= base_url('data_persiapan/persiapan_tahun/delTahun/') . $r->id_tahun; ?>" class="btn btn-sm btn-danger btn-hapus"><i class="fa fa-trash-alt"></i></a>
                                        </td>
                                    </tr>
                                    <?php $i++; ?>
                                <?php endforeach; ?>
        ...
        <div class="modal-content">
            ...
            <form action="<?= base_url('data_persiapan/persiapan_tahun/edittahun'); ?>" method="post">
                <div class=" modal-body">
                    ...
                    <div class="mb-3">
                        <input type="text" class="form-control" id="ed_tahun_aktif" name="ed_tahun_aktif" placeholder="tingkat">
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
