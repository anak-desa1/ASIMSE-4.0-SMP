                                ...
                                <div class="card">
                                    ...
                                    <form method="POST" action="<?= site_url('master_pegawai/data_pegawai/excel') ?>" enctype="multipart/form-data">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="col-md-12 mt-1">
                                                    <span class="text-secondary"><i class="fas fa-download mr-1"></i><a href="<?= base_url() . 'master_pegawai/data_pegawai/lakukan_download' ?>">Download</a> Format file excel</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card-footer text-right">
                                            <div class="form-group mb-0">
                                                <button type="submit" name="master_pegawai/data_pegawai" class="btn btn-primary"><i class="fas fa-upload mr-1"></i>Upload</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
