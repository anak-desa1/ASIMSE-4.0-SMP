             ...
             <div class="card-body p-0" style="display: block;">
                                             ...
                                             <div class="pull-right">
                                                 <a>
                                                     <form action="" id="FormData">
                                                         ...
                                                         <button type="submit" class="btn"><i class="fa fa-chevron-right"></i> <b>Ketuntasan</b> </button>
                                                     </form>
                                                 </a>
                                             </div>
                                         </li>
                             ...
                             <div class="col-md-8">
                                 <div class="card-body">
                                     <ul class="list-group">
                                         ...
                                         <li class="list-group-item">
                                             <div class="pull-right">
                                                 <h3 class="card-title">Untuk melihat Ketuntasan belajar siswa klik menu disamping </h3>
                                             </div>
                                         </li>
                                     </ul>
                                 </div>
                 ...
                 <div class="col-sm-12">
                     <div class="card card-danger">
                         <div class="card-header">
                             <h3 class="card-title">Ketuntasan Belajar Siswa</h3>
                         </div>
                         <div class="card-body">
                             <div class="row">
                                 <div class="col-md-12">
