...
class Cetak_rapor_pat extends CI_Controller
{
    ...
    // {
    //     $this->benchmark->mark('code_start');
    //     $data['title'] = 'Catak Rapor Kelulusan';
    //     $data['home'] = 'Cetak';
    //     $data['subtitle'] = $data['title'];
    //         $data['main_menu'] = main_menu();
    //         $data['sub_menu'] = sub_menu();
    ...
    //     $data['ma'] = $this->db->get_where('m_mapel')->result_array();
    //     $data['kkm'] = $this->db->get('t_kkm')->result_array();
    //     $data['kkm_m'] = $this->cetak_rapor_pat->get_kkm();
    //     // var_dump($data['kkm']);
    //     // die;
    ...
    public function mpdf($id, $target, $th)
    {
        ...
        // pengetahuan dan keterampilan
        $data['mapel'] = $this->cetak_rapor_pat->get_pasmapel($id, $target);
        $data['mapel_kkm'] = $this->db->get_where('m_mapel')->row_array();
        $data['kkm'] = $this->db->get('t_kkm')->result_array();
        $data['nilai_p'] = $this->cetak_rapor_pat->get_nilai_p($id, $target);
        $data['nilai_k'] = $this->cetak_rapor_pat->get_nilai_k($id, $target);
        // end pengetahuan dan keterampilan
        ...
        // end absensi     
        // catatan
        $data['naik_kelas'] = $this->cetak_rapor_pat->get_naik_kelas($id, $target, $th);
       // end catatan
        ...
        $html1 = $this->load->view('akademik_walikelas/cetak_rapor_pat/cetak_rapor_pat_pdf_1', $data, TRUE);
        ...
        $html2 = $this->load->view('akademik_walikelas/cetak_rapor_pat/cetak_rapor_pat_pdf_2', $data, TRUE);
        ...
        $html3 = $this->load->view('akademik_walikelas/cetak_rapor_pat/cetak_rapor_pat_pdf_3', $data, TRUE);
        ...
        $html4 = $this->load->view('akademik_walikelas/cetak_rapor_pat/cetak_rapor_pat_pdf_4', $data, TRUE);
    ...
    public function mpdf_qrcode($id, $target, $th)
    {
        ...
        $html4 = $this->load->view('akademik_walikelas/cetak_rapor_pat/cetak_rapor_pat_pdf_4 qrcode', $data, TRUE);
        $mpdf->WriteHTML($html4);
