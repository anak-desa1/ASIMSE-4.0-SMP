              ...
              <div class="row">
                ...
                <div class="animated fadeInLeft col-md-8">
                  <div class="card card-info">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form class="form-horizontal" role="form" action="<?php echo base_url(); ?>pelanggaran_jenis/barangsita/barangsita_save" method="post">
                      ...
                      <div class="card-body">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-12">
                            <div class="input-group input-group">
                              ...
                              <input type="hidden" name="id_barangsita_siswa" value="<?php echo $id_barangsita_siswa; ?>">
                        ...
                        <div class="form-group">
                          ...
                          <textarea type="text" class="form-control " name="keterangan_sita" placeholder="Barang Yang Disita. . . " required><?php echo $keterangan_sita; ?></textarea>
                        </div>

                        <div class="form-group">
                          <label>Tanggal Sita</label>
                          <input type="text" class="form-control tglcalendar" name="tanggal_sita" value="<?php echo $tanggal_sita; ?>" placeholder="Pilih Tanggal" required>
                        </div>
                      </div>
                      <!-- /.card-body -->
                      <div class="card-footer">
                        <button type="submit" class="btn btn-info float-right ml-3"><i class="fa fa-save"> </i> Simpan</button>
                        <a class="btn btn-danger float-right" href="<?php echo base_url(); ?>pelanggaran_jenis/barangsita"><i class="fa fa-undo"> </i> Kembali</a>
                      </div>
                      <!-- /.card-footer -->
                    </form>
                  </div>
