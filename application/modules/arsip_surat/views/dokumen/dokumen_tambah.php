              ...
              <form class="form-horizontal" role="form" action="<?php echo base_url(); ?>arsip_surat/dokumen/dokumen_save" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body col-sm-12">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <input type="date" class="form-control tglcalendar" name="tanggal_dokumen" value="<?php echo $tanggal_dokumen; ?>" required style="font-size: 14px">
                  </div>
                  <div class="form-group col-md-6">
                    <label>Jenis Dokumen</label>
                    <select class="form-control select2" name="id_jenis_dokumen" required style="font-size: 14px">
