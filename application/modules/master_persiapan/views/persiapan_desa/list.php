                            ...
                            <tbody>
                                ...
                                <?php foreach ($desa as $r) : ?>
                                    <tr>
                                        ...
                                        <td><?= $r['desa']; ?></td>
                                        <td>
                                            <a class="btn btn-sm btn-warning" href="" data-kecamatan_id="<?= $r['kecamatan_id']; ?>" data-desa="<?= $r['desa']; ?>" data-id="<?= $r['id']; ?>" data-toggle="modal" data-target="#editModal" title="Edit"><i class="fa fa-edit"></i></a>
                                            <a href="<?= base_url('data_persiapan/persiapan_desa/deldesa/') . $r['id'] ?>" class="btn btn-sm btn-danger btn-hapus"><i class="fa fa-trash-alt"></i></a>
                                        </td>
                                    </tr>
                                    <?php $i++; ?>
                                <?php endforeach; ?>
