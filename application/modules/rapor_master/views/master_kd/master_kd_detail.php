                             ...
                             <ul class="list-group">
                                 <?php
                                    if (!empty($mapel)) {
                                        foreach ($mapel as $m) {
                                    ?>
                                         <li class="list-group-item"><a href="#" class="text-muted"><i class="fa fa-chevron-right"></i><button type="submit" class="btn"><b style="color:white"><?php echo $m['nama']; ?></b></button></a></li>
                                 <?php
                                        }
                                    } else {
