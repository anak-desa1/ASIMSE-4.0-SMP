                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-header p-2">
                            <a class="btn btn-warning mb-3" href="<?= site_url('akademik_walikelas/nilai_prestasi/') ?>"><i class="fa fa-arrow-circle-left"></i> Kembali</a>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        if (!empty($prestasi)) {
                                                            foreach ($prestasi as $p) {
                                                                $no++;
                                                                $html .= '<tr><td class="ctr">' . $no . '</td><td>' . $p['nmsiswa'] . '</td><td class="ctr">' . $p['jenis'] . '</td><td class="ctr">' . $p['keterangan'] . '</td><td class="ctr"><a href="' . base_url() . 'akademik_walikelas/nilai_prestasi/del/' . $p['id'] . '" class="btn btn-xs btn-danger"><i class="fa fa-trash-alt"></i> Delete</a></td></tr>';
                                                            }
                                                        } else {
