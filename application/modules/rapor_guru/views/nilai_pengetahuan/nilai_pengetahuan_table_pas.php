 <form method="post" action="<?= base_url() . $this->uri->segment(1, 0) . $this->uri->slash_segment(2, 'both') . 'nilai_simpan' ?>" role="form" id="form-action" enctype="multipart/form-data">
     ...
     <div class="card-body">
         ...
         <input type="hidden" name="id_mapel_kd" value="<?= $mapel['id_mapel'] ?>">
             ...
             <div class="col-md-12">
                 <div class="row">
                     ...
                     <!-- <div class="col-md-3 form-group">
                         ...
                         <select class="form-control select2" style="width: 100%;" id="id_mapel_kd" name="id_mapel_kd">
                             <option value="">KD</option>
                             <?php foreach ($kd as $kel) {
                                    echo '<option value="' . $kel['kd_id'] . '">' . $kel['no_kd'] . '</option>';
                                } ?>
                         </select>
                     </div>
                     <div class="col-md-3 form-group">
