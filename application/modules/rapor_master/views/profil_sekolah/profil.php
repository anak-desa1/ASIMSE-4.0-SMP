                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                <div class="tab-pane active" id="profil">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="nss" name="nss" value="<?= $sekolah['nss'] ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="nama_sekolah" name="nama_sekolah" value="<?= $sekolah['nama_sekolah'] ?>" readonly>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <textarea class="form-control" id="alamat" name="alamat" readonly><?= $sekolah['alamat'] ?></textarea>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="telp" name="telp" value="<?= $sekolah['telp'] ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputKecamatan" class="col-sm-4 col-form-label">Kode Pos</label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="kodepos" name="kodepos" value="<?= $sekolah['kodepos'] ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputEmail" class="col-sm-4 col-form-label">Email</label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="email" name="email" value="<?= $sekolah['email'] ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputweb" class="col-sm-4 col-form-label">Website</label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="web" name="web" value="<?= $sekolah['web'] ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputsebutan_kepala" class="col-sm-4 col-form-label">Kepala Sekolah</label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="sebutan_kepala" name="sebutan_kepala" value="<?= $sekolah['sebutan_kepala'] ?>" readonly>
                                            </div>
                                        </div>
                                        <!-- <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            <label for="inputSkills" class="col-sm-4 col-form-label">Logo Sekolah</label>
                                            <div class="col-sm-8">
                                                <div class="row">
                                                    <div class="col-sm-3">
                                ...
                                <div class="tab-pane" id="biodata">
                                    ...
                                    <div class="form-group row">
                                        <label for="tahun" class="col-sm-4 control-label">Tgl TTD Raport PAS <span class=" symbol required"> </span></label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group row">
                                        <label for="tahun" class="col-sm-4 control-label">Tgl TTD Raport PAT <span class=" symbol required"> </span></label>
                                        <div class="col-sm-8">
                                            <!-- <label for="tahun" class="col-sm-5 control-label"><?php echo format_indo(date($tahun['tgl_raport_pat'])); ?></label> -->
                                            <input type="date" name="tgl_raport_pat" value="<?= $tahun['tgl_raport_pat'] ?>" class="col-sm-5 form-control" id="tgl_raport_pat" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
